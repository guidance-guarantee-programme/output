...
ActiveRecord::Schema.define(version: 20161207154853) do
  ...
  create_table "appointment_summaries_batches", force: :cascade do |t|
    ...
    t.integer "batch_id"
    t.index ["appointment_summary_id"], name: "index_appointment_summaries_batches_on_appointment_summary_id", using: :btree
    t.index ["batch_id"], name: "index_appointment_summaries_batches_on_batch_id", using: :btree
  end
